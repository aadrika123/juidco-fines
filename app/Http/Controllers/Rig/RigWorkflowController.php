            ...
            try {
                $baseQuerry = $mRigApprovedRegistration->getAllApprovdApplicationDetails()
                    ->select(
                        ...
                        "rig_approved_registrations.id as application_id",
                        "rig_approved_registrations.application_id as id",
            ...
            try {
                $baseQuerry = $mRigRejectedRegistration->getAllRejectedApplicationDetails()
                    ->select(
                        ...
                        "rig_rejected_registrations.id as application_id",
                        "rig_rejected_registrations.application_id as id",
